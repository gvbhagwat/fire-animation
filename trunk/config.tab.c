...
/* Line 288 of yacc.c  */
#line 15 "config.y"
 /* Places this code above the default YYSTYPE declaration in .tab.h */
	#include "config.h" 



/* Line 288 of yacc.c  */
#line 121 "config.tab.c"
...
/* Line 340 of yacc.c  */
#line 19 "config.y"
 /* Places this code below the YYSTYPE declarations */
...
/* Line 340 of yacc.c  */
#line 165 "config.tab.c"

/* Copy the second part of user declarations.  */


/* Line 343 of yacc.c  */
#line 171 "config.tab.c"
...
{
      16,     0,    -1,    16,    17,     7,    -1,    -1,     6,    12,
      18,    -1,    -1,    19,    -1,     5,    -1,     3,    -1,     4,
      -1,    13,    19,    14,    -1,    19,     8,    19,    -1,    19,
...
{
       0,    42,    42,    43,    47,    59,    63,    65,    69,    71,
      73,    75,    89,   103,   117,   131
};
#endif
...
{
  "$end", "error", "$undefined", "INTEGER_LITERAL", "DOUBLE_LITERAL",
  "STRING_LITERAL", "IDENTIFIER", "EOL", "'+'", "'-'", "'*'", "'/'", "'='",
  "'('", "')'", "$accept", "configs", "config", "value", "expression", 0
};
#endif
...
{
      -4,     6,    -4,    12,    16,    -3,    -4,    -4,    -4,    -4,
      -4,     1,    -4,    18,    11,     1,     1,     1,     1,    -4,
      -2,    -2,    -4,    -4
};
...
{
       7,     8,     9,    10,     7,     8,     2,    10,    17,    18,
      11,    14,     3,     0,    11,    20,    21,    22,    23,    15,
      16,    17,    18,     6,     5,    19,    15,    16,    17,    18
};
...
{
       3,     4,     5,     6,     3,     4,     0,     6,    10,    11,
      13,    11,     6,    -1,    13,    15,    16,    17,    18,     8,
       9,    10,    11,     7,    12,    14,     8,     9,    10,    11
};
...
{
       0,    16,     0,     6,    17,    12,     7,     3,     4,     5,
       6,    13,    18,    19,    19,     8,     9,    10,    11,    14,
      19,    19,    19,    19
};
...
#line 47 "config.y"
    {
		...
		char* key = (yyvsp[(1) - (3)]).data.charBuf;
		...
		configVars[numVars++].value = (yyvsp[(3) - (3)]); // Copies the YYSTYPE
	}
    break;
...
#line 75 "config.y"
    {
		if ((yyvsp[(1) - (3)]).type == INTEGER && (yyvsp[(3) - (3)]).type == INTEGER) { // only then result is INTEGER
			(yyval).type = INTEGER;
			int op1 = (yyvsp[(1) - (3)]).data.intVal;
			int op2 = (yyvsp[(3) - (3)]).data.intVal;
			(yyval).data.intVal = op1 + op2;
		} else { // at least one is a double, so result is also double
			(yyval).type = DOUBLE;
			double op1 = (yyvsp[(1) - (3)]).type == INTEGER ? (yyvsp[(1) - (3)]).data.intVal : (yyvsp[(1) - (3)]).data.floatVal;
			double op2 = (yyvsp[(3) - (3)]).type == INTEGER ? (yyvsp[(3) - (3)]).data.intVal : (yyvsp[(3) - (3)]).data.floatVal;
			(yyval).data.floatVal = op1 + op2;
		}
	}
    break;
...
#line 131 "config.y"
    {
		...
		char* key = (yyvsp[(1) - (1)]).data.charBuf;
